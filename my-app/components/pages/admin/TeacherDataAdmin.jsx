...
export default function TeacherDataAdmin() {
  const data = [
    { no: 1, name: "Ahmad", username: "ahmad123", class: "10A" },
    { no: 2, name: "Budi", username: "budi456", class: "10B" },
    { no: 3, name: "Citra", username: "citra789", class: "10A" },
    { no: 4, name: "Dewi", username: "dewi987", class: "10B" },
    { no: 5, name: "Eko", username: "eko654", class: "10C" },
    { no: 6, name: "Fajar", username: "fajar432", class: "10C" },
    { no: 7, name: "Gilang", username: "gilang987", class: "10A" },
    { no: 8, name: "Hana", username: "hana345", class: "10B" },
    { no: 9, name: "Ika", username: "ika123", class: "10C" },
    { no: 10, name: "Joko", username: "joko456", class: "10C" },
    { no: 11, name: "Lia", username: "lia001", class: "10A" },
    { no: 12, name: "Mia", username: "mia002", class: "10A" },
  ];
    ...
    <View className="flex-1 bg-gray-100">
      ...
      <View className="p-4">
        ...
        >
          ...
          <Text className="text-white font-semibold ml-2">Tambah Guru</Text>
        </TouchableOpacity>
      </View>
