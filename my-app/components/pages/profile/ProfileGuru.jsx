...
=======
            className="border border-gray-400 p-2 rounded-lg h-12 justify-center"
>>>>>>> 59023703f16bda40da5490813954d82be41856ee
          >
        ...
        <View className="mb-6">
          <Text className="text-sm mb-1 text-gray-700">Pengampu Kelas</Text>
          <View className="border border-gray-400 rounded-lg h-12 justify-center">
            <Picker
