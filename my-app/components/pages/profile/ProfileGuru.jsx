...
export default function ProfileGuru() {
  ...
  const [gender, setGender] = useState(""); // State untuk select gender
  const [className, setClassName] = useState(""); // State untuk Kelas

  const [email, setEmail] = useState("");
  const [password, setPassword] = useState("");
  const [username, setUsername] = useState(""); // Username state di sini
  ...
  return (
    <View className="flex-1 bg-gray-100">
      ...
      >
        ...
        <View className="mb-4">
          <Text className="text-sm mb-1 text-gray-700">NIP</Text>
          <TextInput
            value={nip}
            onChangeText={setNip}
            placeholder="NIP"
        ...
        <View className="mb-4">
          <Text className="text-sm mb-1 text-gray-700">Kelas Yang Diajar</Text>
          <View className="border border-gray-500 p-2 rounded-lg h-12 justify-center">
            <Picker
